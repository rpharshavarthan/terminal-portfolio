...
const content = (val) => {
    ...
    if(val == "help"){
        ...
        if you would like to check out my cv, simply type <span class="underline">cv</span>. have a good
        day!</div>`;
        append(val, showMe, showHere);
    }
    else if (val == "edu"){
        ...
        me on <span><a href="https://github.com/rpharshavarthan" class="underline">github</a>
        </span></div>`;
        append(val, showMe, showHere);
    }
    else if(val == 'contact'){
        ...
        showMe = `<div class="text">
        <div><span>story is bit long, are you sure you want to continue?</span></div>
        <div><span>if yes, enter 'cont' to continue</span></div></div>`;
        append(val, showMe, showHere);
    }
    else if(val == 'website'){
